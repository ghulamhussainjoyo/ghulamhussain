			...
			function n(n, r) {
				...
				if (
					((o.addStylesAndEvents = function() {
						window.scroll(0, 0),
							...
							(o.wrapperElement.style.transition =
								o.options.transitionTime.toString() + 'ms cubic-bezier(0.5, 0, 0.5, 1)'),
					...
					n instanceof HTMLElement
						? (o.wrapperElement = n)
						: 'string' == typeof n && (o.wrapperElement = document.getElementById(n)),
					null === o.wrapperElement)
				)
					throw 'An Element with the given ID could not be found.';
				return (
					(o.slides = o.wrapperElement.querySelectorAll(o.options.slideSelector)),
			...
			return function(e, t, n, i) {
				...
				(this.addEventListeners = function() {
					...
					(this.removeEventListeners = function() {
						a.target.removeEventListener('touchstart', a.touchstartEventHandler),
							a.target.removeEventListener('touchend', a.touchendEventHandler),
							a.target.removeEventListener('touchmove', a.touchmoveEventHandler);
					}),
					...
					(this.touchendEventHandler = function(e) {
						...
						new Date().getTime() - a.touchEvent.touchstartTime <= a.swipeOptions.maxSwipeTime &&
							(Math.abs(o) > Math.abs(i)
								? Math.abs(o) > a.swipeOptions.swipeMinDistance && (t = o < 0 ? r.LEFT : r.RIGHT)
								: Math.abs(i) > a.swipeOptions.swipeMinDistance && (t = i < 0 ? r.UP : r.DOWN),
							t === r.UP ? a.nextCallback() : t === r.DOWN && a.previousCallback(),
							e.stopPropagation());
					}),
					...
					(this.wheelEventHandler = function(e) {
						...
						(a.lastCall = r),
							(!n && o < a.options.newScrollThreshold) ||
								(e.stopPropagation(), t < 0 && a.previousCallback(), t > 0 && a.nextCallback());
					}),
					(this.target = e),
					(this.nextCallback = n),
	...
	function(e, t, n) {
		...
		function a(e) {
			null == e.passiveListener
				? e.event.cancelable &&
					((e.canceled = !0), 'function' == typeof e.event.preventDefault && e.event.preventDefault())
		...
		(s.prototype = {
			...
			'undefined' != typeof window &&
				void 0 !== window.Event &&
				(Object.setPrototypeOf(s.prototype, window.Event.prototype), o.set(window.Event.prototype, s));
		const v = new WeakMap(),
			f = 3;
		function h(e) {
				...
				(function(e) {
					return {
						...
						set(t) {
							...
							for (; null != o; )
								o.listenerType === f
									? null !== r ? (r.next = o.next) : null !== o.next ? n.set(e, o.next) : n.delete(e)
									: (r = o),
									(o = o.next);
							if (null !== t) {
			...
			removeEventListener(e, t, n) {
				...
				for (; null != a; ) {
					if (a.listener === t && a.listenerType === o)
						return void (null !== i ? (i.next = a.next) : null !== a.next ? r.set(e, a.next) : r.delete(e));
					(i = a), (a = a.next);
				}
			},
			dispatchEvent(e) {
				...
				for (; null != r; ) {
					if (
						(r.once
							? null !== a ? (a.next = r.next) : null !== r.next ? t.set(n, r.next) : t.delete(n)
							: (a = r),
